...
<div class="container-fluid">
    ...
    <div class="row-fluid">
    	<div class="well">
    		<h4 class="text-center"><?php echo ucfirst($emp_type) ?> (<?php echo strtoupper($emp_cat) ?>) Salary Bill For the Month <?php echo $sel_month ?></h4>
    	</div>
    </div>
    <div class="row-fluid">
    	<div>
    		<a class="btn btn-info" href="<?php echo base_url() ?>teaching/salary_bill"><i class="icon-arrow-left icon-white"></i> Back</a>
